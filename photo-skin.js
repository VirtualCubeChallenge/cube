...
(function (global) {
  ...
  const PS_I18N = {
    ja: {
      ...
      psPrivacy: "🔒 画像はお使いの端末内にのみ保存され、外部へ送信されることはありません。",
      psPrivacyShort: "画像はお使いの端末内にのみ保存され、外部へ送信されることはありません。",
      ...
      psGuideP1: "画像はお使いの端末内にのみ保存され、外部へ送信されることはありません。",
      psGuideH1: "■ 権利に関するご注意",
      psGuideP2: "他人が写っている写真、有名人の画像、キャラクター・ロゴなどの画像を貼り付けた画面を、SNS等へ公開・投稿しないでください。",
    ...
    en: {
      ...
      psPrivacy: "🔒 Images are stored only on your device and are never sent anywhere.",
      psPrivacyShort: "Images are stored only on your device and are never sent anywhere.",
      ...
      psGuideP1: "Images are stored only on your device and are never sent anywhere.",
      psGuideH1: "■ About rights",
      psGuideP2: "Please do not publish or post to social media any screen using photos of other people, images of celebrities, or characters and logos.",
    ...
    'zh-CN': {
      ...
      psPrivacy: "🔒 图片仅保存在您的设备中，不会被发送到外部。",
      psPrivacyShort: "图片仅保存在您的设备中，不会被发送到外部。",
      ...
      psGuideTitle: "关于原创皮肤",
      psGuideP1: "图片仅保存在您的设备中，不会被发送到外部。",
      psGuideH1: "■ 关于权利的注意事项",
      psGuideP2: "请勿将使用了他人照片、名人图像、角色或标志等图片的画面公开或发布到社交网络等平台。",
    ...
    'zh-TW': {
      ...
      psPrivacy: "🔒 圖片僅儲存在您的裝置中，不會被傳送到外部。",
      psPrivacyShort: "圖片僅儲存在您的裝置中，不會被傳送到外部。",
      ...
      psGuideTitle: "關於原創外觀",
      psGuideP1: "圖片僅儲存在您的裝置中，不會被傳送到外部。",
      psGuideH1: "■ 關於權利的注意事項",
      psGuideP2: "請勿將使用了他人照片、名人圖像、角色或標誌等圖片的畫面公開或發布到社群網站等平台。",
    ...
    ko: {
      ...
      psPrivacy: "🔒 이미지는 사용 중인 기기 안에만 저장되며 외부로 전송되지 않습니다.",
      psPrivacyShort: "이미지는 사용 중인 기기 안에만 저장되며 외부로 전송되지 않습니다.",
      ...
      psGuideP1: "이미지는 사용 중인 기기 안에만 저장되며 외부로 전송되지 않습니다.",
      psGuideH1: "■ 권리에 관한 안내",
      psGuideP2: "다른 사람이 찍힌 사진, 유명인의 이미지, 캐릭터·로고 등의 이미지를 붙인 화면을 SNS 등에 공개·게시하지 말아 주세요.",
    ...
    es: {
      ...
      psPrivacy: "🔒 Las imágenes se guardan solo en tu dispositivo y no se envían al exterior.",
      psPrivacyShort: "Las imágenes se guardan solo en tu dispositivo y no se envían al exterior.",
      shopMarkOriginal6: "Original ×6",
      ...
      psGuideP1: "Las imágenes se guardan solo en tu dispositivo y no se envían al exterior.",
      psGuideH1: "■ Sobre los derechos",
      psGuideP2: "No publiques en redes sociales pantallas que usen fotos de otras personas, imágenes de famosos, ni personajes o logotipos.",
    ...
    id: {
      ...
      psPrivacy: "🔒 Gambar hanya disimpan di perangkatmu dan tidak dikirim ke luar.",
      psPrivacyShort: "Gambar hanya disimpan di perangkatmu dan tidak dikirim ke luar.",
      shopMarkOriginal6: "Original ×6",
      ...
      psGuideP1: "Gambar hanya disimpan di perangkatmu dan tidak dikirim ke luar.",
      psGuideH1: "■ Tentang hak",
      psGuideP2: "Mohon jangan memublikasikan atau memposting ke media sosial tampilan yang memakai foto orang lain, gambar selebritas, atau karakter dan logo.",
    ...
    ru: {
      ...
      psPrivacy: "🔒 Изображения хранятся только на вашем устройстве и не передаются наружу.",
      psPrivacyShort: "Изображения хранятся только на вашем устройстве и не передаются наружу.",
      ...
      psGuideP1: "Изображения хранятся только на вашем устройстве и не передаются наружу.",
      psGuideH1: "■ О правах",
      psGuideP2: "Пожалуйста, не публикуйте в соцсетях экраны с фотографиями других людей, изображениями знаменитостей, персонажами или логотипами.",
    ...
    'pt-BR': {
      ...
      psPrivacy: "🔒 As imagens ficam guardadas só no seu aparelho e não são enviadas para fora.",
      psPrivacyShort: "As imagens ficam guardadas só no seu aparelho e não são enviadas para fora.",
      shopMarkOriginal6: "Original ×6",
      ...
      psGuideP1: "As imagens ficam guardadas só no seu aparelho e não são enviadas para fora.",
      psGuideH1: "■ Sobre os direitos",
      psGuideP2: "Por favor, não publique em redes sociais telas que usem fotos de outras pessoas, imagens de celebridades, nem personagens ou logotipos.",
  ...
  function buildGuide() {
    ...
    ov.innerHTML =
      '<div class="ps-panel psg-panel">' +
        ...
        '<h3 class="psg-h" data-psg="h1"></h3>' +
        '<p class="psg-p" data-psg="p2"></p>' +
        '<p class="psg-p" data-psg="p3"></p>' +
        '<h3 class="psg-h" data-psg="h2"></h3>' +
        '<p class="psg-p" data-psg="p4"></p>' +
  ...
  function openGuide() {
    ...
    g.h1.textContent = T('psGuideH1');
    g.h2.textContent = T('psGuideH2');
    g.p4.textContent = T('psGuideP4');
